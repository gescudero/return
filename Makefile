...
RAYLIB_PATH           ?= /xtra/code/c/raylib/raylib
...
ifeq ($(PLATFORM),PLATFORM_WEB)
    ...
    EMSDK_PATH         ?= /xtra/code/c/raylib/emsdk
    EMSCRIPTEN_PATH    ?= $(EMSDK_PATH)/upstream/emscripten
    CLANG_PATH          = $(EMSDK_PATH)/upstream/bin
    PYTHON_PATH         = $(EMSDK_PATH)/python/3.13.3_64bit
    NODE_PATH           = $(EMSDK_PATH)/node/24.19.0_64bit/bin
...
#------------------------------------------------------------------------------------------------
OBJS = $(patsubst %.c, $(OBJ_DIR)/%.o, $(PROJECT_SOURCE_FILES))
